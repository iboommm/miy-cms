...
?>
       ...
       <script>
       		...
       		$.getJSON('genJSON/layout/YG5hbWVgIExJS0UgJ3NpZGVfcmlnaHQn', function(json, textStatus) {
       			...
       			$.each(test, function(input,val) {
       				...
       				$.getJSON('genJSON/module/' + id, function(data, textStatus) {
       					$('#dataRight').append("<div class='col-lg-12 module-header'>" + data.module[0].name + "</div><div class='col-lg-12 module-content'>" + data.module[0].data + "</div>");
       				});
       			});
       		});
       </script>
