                ...
                app.controller('customersCtrl', function($scope, $http) {
                  $http.get("genJSON/ems").then(function (response) {
                      $scope.myData = response.data.ems;
                  });
                });
                </script>
                    ...
                    <div class="col-xs-12">
                        ...
                        <form role="form">
                            <div class="col-xs-12 container">
                                ...
                                <div class="col-xs-2 ">{{ group.code }}</div>
                                <div class="col-xs-2 ">{{ group.time }}</div>
                                <div class="col-xs-3 "><a href="#"><i class="fa fa-remove"></i> <?php echo $lang["Admin-remove"]; ?></a> </div>
