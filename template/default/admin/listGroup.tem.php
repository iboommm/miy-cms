                ...
                app.controller('customersCtrl', function($scope, $http) {
                  $http.get("genJSON/shop_group").then(function (response) {
                      $scope.myData = response.data.shop_group;
                  });
                });
                </script>
                    ...
                    <div class="col-xs-12">
                        ...
                        <form role="form">
                            <div class="col-xs-12 container">
                                ...
                                <div class="col-xs-3 "><a href="admin.php?mode=edit-group&id={{ group.id }}"><i class="fa fa-pencil-square-o"></i> <?php echo $lang["Admin-edit"]; ?></a> </div>
                                
                           </div>
                            </div>
                            <div class="col-xs-12 container list-group">
                            <button onclick="location.href = 'admin.php?mode=add-group'" class="btn btn-primary">Add Group</button>
                             </div>   
                        </form>
