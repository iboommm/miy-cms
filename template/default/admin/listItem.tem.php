                ...
                app.controller('customersCtrl', function($scope, $http) {
                  $http.get("genJSON/shop_item").then(function (response) {
                      $scope.myData = response.data.shop_item;
                  });
                });
                </script>
                    ...
                    <div class="col-xs-12">
                        ...
                        <form role="form">
                            <div class="col-xs-12 container">
                                ...
                                <div class="col-xs-3 "><a href="admin.php?mode=edit-item&id={{ group.id }}"><i class="fa fa-pencil-square-o"></i> <?php echo $lang["Admin-edit"]; ?></a> </div>
                                
                           </div>
                            </div>
                            <div class="col-xs-12 container list-group">
                            <button onclick="location.href = 'admin.php?mode=add-item'" class="btn btn-primary">Add Group</button>
                             </div>   
                        </form>
