                ...
                <div class="row" >
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-cog"></i> Add Article
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12" id="add-module-form">
                        ...
                        <form role="form">
                            <input type="name" id="name" class="form-control" placeholder="Enter Article name">
                            <textarea name="edit" id="editor" cols="30" rows="10"></textarea>

                            <button id="confirm" type="button" class="btn btn-primary">Add Article</button>
                ...
                <script>
                    ...
                    $('#confirm').click(function(event) {
                        ...
                        $.post('admin.php?mode=add-article', {data: genData,sending: "add-article"}, function(data){
                          if(data == 1) {
                                var name = $('#name').val();
